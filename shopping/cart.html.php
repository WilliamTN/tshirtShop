...
if(!isset($pageTitle))
{
header('Location: /tshirtShop/shopping/cart.html.php');
}
      ...
      <?php include_once '../includes/header.inc.php'; ?>
       ...
       <div class="center_content">
	    ...
	    <div class="error"><?php echo $error; ?></div>
		       	...
		       	<?php
		   			if(isset($_SESSION['cart']) && is_array($_SESSION['cart'])){
		   				...
		   				for($i=0;$i<$max;$i++){
		   					...
		   					$pname=get_product_name($pid,$link);
		   					if($q==0) continue;
		   			?>
		               		<tr bgcolor="#FFFFFF"><td><?php echo $pname?></td>
		                       <td><?php echo get_price($pid,$link)?></td>
		                       <td><input type="text" name="product<?php echo $pid?>" value="<?php echo $q?>" maxlength="3" size="2" /></td>
		                       <td><?php echo get_price($pid,$link)*$q?></td>
		                       <td><a href="index.php?command=delete&item_code=<?php echo $pid;?>">Remove</a></td></tr>
		               <?php
		   				}
		   			?>
		   				<tr><td colspan="2"><b>Order Total: $<?php echo get_order_total($link)?></b></td><td colspan="3" align="right">
            ...
            <a href="/tshirtShop/books/index.php" class="continue">&lt; continue</a>
            ...
            ?>
				...
				<a href="stripePayment/index.html.php?checkout" class="checkout">PAY NOW &gt;</a>
